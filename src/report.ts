import type { WalkForwardSummary } from "./validate/walkforward.js";

export function buildReport(args: {
  meta: { asset:string; timeframe:string; bars:number };
  base: any;
  wf: WalkForwardSummary;
  mc: {
    cagr: { mean:number; sd:number; p05:number; p50:number; p95:number };
    mdd:  { mean:number; sd:number; p05:number; p50:number; p95:number };
    sharpe:{ mean:number; sd:number; p05:number; p50:number; p95:number };
  };
}) {
