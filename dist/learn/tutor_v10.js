...
function buildHtml(memory, feedback) {
...
<body>
  <div class="wrap">
    ...
    <div class="card" style="margin-top:12px">
      ...
      <pre>${feedback.replace(/[<>&]/g, s => ({ '<': '&lt;', '>': '&gt;', '&': '&amp;' }[s]))}</pre>
    </div>
...
export function runTutorV10() {
    ...
    const memory = JSON.parse(fs.readFileSync(inputPath, "utf8"));
